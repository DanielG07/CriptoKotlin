...
import com.danielg7.cripto.data.remote.models.CriptoNetwork
import com.danielg7.cripto.data.remote.models.mapToDomain
    ...
    override suspend fun getCriptos(): DataState<List<Cripto>, ErrorResponse> {
        ...
        try {
            ...
            if (response.isSuccessful) {
                ...
                val criptos: List<CriptoNetwork>? = response.body()?.payload
                if (criptos != null) {

                    return DataState.Success(data = criptos.mapToDomain())
                } else {
